...
var scratchblocks = function () {
  ...
  Icon.prototype.draw = function() {
    ...
    return symbol(document.location.pathname + '#' + this.name, {
      width: this.width,
      height: this.height,
    });
  };
